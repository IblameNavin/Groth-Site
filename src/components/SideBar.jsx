...
const SideBar = () => {
  ...
  return (
    <>
     <div
  ref={sidebarRef}
  className='bg-[#BF551A] w-full md:w-[360px] lg:w-[360px] overflow-y-auto relative lg:fixed top-0 right-0 z-40 py-10'
  style={{ maxHeight: maxHeight }}
>
        <div className='flex flex-col items-center p-4 md:p-6 lg:p-8 text-[18px] md:text-[20px] lg:text-[25px] w-full gap-6 lg:gap-8'>
          <div className='flex flex-col-reverse lg:flex-row items-center gap-4 shrink-0 w-full justify-between'>
            <div className='flex items-center gap-4 w-full lg:max-w-[60%]'>
              <div className='h-6 w-6 rounded-sm bg-gray-950 flex-shrink-0'></div>
              <h1 className='text-black font-semibold break-words text-[18px] md:text-[20px] lg:text-[22px]'>Research And Design</h1>
            </div>

          </div>

          <div className='flex flex-col gap-8 mt-4 lg:mt-0'>
            <div className='flex flex-col items-center shrink-0 w-[260px]'>
              <img className='mt-5 h-[200px] lg:h-[260px] w-[260px] bg-[#C3A392] object-cover filter sepia brightness-70 rounded-lg' src={Try} alt="" />
            ...
            <div className='flex flex-col items-center shrink-0 w-[260px]'>
              <img className='mt-5 h-[200px] lg:h-[260px] w-[260px] bg-[#C3A392] object-cover filter sepia brightness-70 rounded-lg' src={BoyImg} alt="" />
              <div className='mt-5 w-[260px]'>
            ...
            <div className='flex flex-col items-center shrink-0 w-[260px]'>
              <img className='mt-5 h-[200px] lg:h-[260px] w-[260px] bg-[#C3A392] object-cover filter sepia brightness-70 rounded-lg' src={CastleImg} alt="" />
              <div className='mt-5 w-[260px]'>
