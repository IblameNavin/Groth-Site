      ...
      <div>
        <div className="flex flex-col lg:flex-row gap-6 items-center pt-6 ">
          <div className="flex-1 font-semibold pt-10 lg:pt-30 ">
            <img src={RonanSmthImg} className='h-[150px] lg:h-[250px]' alt="" />
            <h1 className="text-3xl lg:text-5xl font-bold pt-5">Ronan</h1>
          ...
          <div className="flex-1 w-full">
            <img src={RonanImg} alt="Ronan" className="w-full h-auto rounded-lg" />
          </div>
        </div>
