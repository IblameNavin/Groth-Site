  ...
  return (
    ...
    <div className="flex gap-6 items-center pt-6 ">
      <div className="flex-1 font-semibold pt-30 ">
       <img src= {ErnestoLaptopImg} className='h-[250px]' alt="" />
        <h1 className="text-5xl font-bold pt-5">Ernesto's</h1>
      ...
      <div className="flex-1">
        <img src={ErnestoImg} alt="Catskills Residence" className="w-full h-auto rounded-lg" />
      </div>
    </div>
