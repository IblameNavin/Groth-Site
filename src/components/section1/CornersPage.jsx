  ...
  return (
    ...
    <div className="flex gap-6 items-center pt-6 ">
      <div className="flex-1 font-semibold pt-30 ">
       <img src= {CornerBench} className='h-[250px]' alt="" />
        <h1 className="text-5xl font-bold pt-5">Corners</h1>
      ...
      <div className="flex-1">
        <img src={CornerImg} alt="Catskills Residence" className="w-full h-auto rounded-lg" />
      </div>
    </div>
